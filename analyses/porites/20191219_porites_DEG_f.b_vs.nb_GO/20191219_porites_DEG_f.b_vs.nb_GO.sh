...
salmon_out_dir="/media/sam/4TB_toshiba/porites/20191219_porites_DEG_f.b_vs.nb_GO"
...
samples="/home/sam/gitrepos/coral_rnaseq_2017/scripts/porites_b_vs_nb_female_trinity_sample_list.txt"
...
NB_female_44_01/quant.sf \
NB_female_44_02/quant.sf \
NB_female_44_03/quant.sf \
NB_female_k5_01/quant.sf \
NB_female_k5_02/quant.sf \
NB_female_k5_03/quant.sf \
1> ${matrix_stdout} \
2> ${matrix_stderr}
...
sed '/^Subject:/ s/ / JOB COMPLETE porites f b-vs-nb/' ~/.default-subject.mail | msmtp "$EMAIL"
