...
# get gene lengths
gene_lengths = read.table("/media/sam/4TB_toshiba/porites/20210622_porites_cnidaria_DEG_bleached_vs_non-bleached_all_GO/Trinity.gene_lengths.txt", header=T, row.names=1, com='')
