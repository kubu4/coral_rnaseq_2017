...
samples_data = read.table("/gscratch/scrubbed/samwhite/outputs/20211015_mcap_DEG_pairwise_comparisons/44_k4/44_k4.samples.txt", header=F, check.names=F, fill=T)
