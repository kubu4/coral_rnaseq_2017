...
samples_data = read.table("/gscratch/scrubbed/samwhite/outputs/20211015_mcap_DEG_pairwise_comparisons/bleached-44_non-bleached-44/bleached-44_non-bleached-44.samples.txt", header=F, check.names=F, fill=T)
