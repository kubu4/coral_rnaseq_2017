...
samples_data = read.table("/gscratch/scrubbed/samwhite/outputs/20211015_mcap_DEG_pairwise_comparisons/bleached-k4_non-bleached-k4/bleached-k4_non-bleached-k4.samples.txt", header=F, check.names=F, fill=T)
