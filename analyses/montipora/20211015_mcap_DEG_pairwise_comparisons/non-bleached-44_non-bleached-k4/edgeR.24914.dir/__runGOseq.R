...
GO_info = read.table("/gscratch/srlab/sam/data/M_capitata/transcriptomes/20211115.mcap.trinotate.go_annotations.txt", header=F, row.names=1,stringsAsFactors=F)
