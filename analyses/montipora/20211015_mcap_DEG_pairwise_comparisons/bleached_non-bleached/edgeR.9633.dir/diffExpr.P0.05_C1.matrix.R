...
samples_data = read.table("/gscratch/scrubbed/samwhite/outputs/20211015_mcap_DEG_pairwise_comparisons/bleached_non-bleached/bleached_non-bleached.samples.txt", header=F, check.names=F, fill=T)
