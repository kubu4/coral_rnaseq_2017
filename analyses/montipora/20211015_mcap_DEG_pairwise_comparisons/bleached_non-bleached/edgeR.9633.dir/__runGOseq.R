...
# get gene lengths
gene_lengths = read.table("/gscratch/scrubbed/samwhite/outputs/20211015_mcap_DEG_pairwise_comparisons/bleached_non-bleached/Trinity.gene_lengths.txt", header=T, row.names=1, com='')
