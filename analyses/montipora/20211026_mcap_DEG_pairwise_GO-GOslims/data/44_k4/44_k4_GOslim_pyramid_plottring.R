...
df1 <- read.csv("analyses/44_k4/P0.05_C1.44-UP.subset.GOseq.enriched.flattened.FDR_1.0.BP.GOslims.csv")

# Read in second comparison file
df2 <- read.csv("analyses/44_k4/P0.05_C1.k4-UP.subset.GOseq.enriched.flattened.FDR_1.0.BP.GOslims.csv")
