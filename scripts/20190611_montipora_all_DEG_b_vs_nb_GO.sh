...
salmon_out_dir="/media/sam/4TB_toshiba/montipora/20190611_montipora_all_DEG_b_vs_nb_GO"
...
samples="/home/sam/gitrepos/coral_rnaseq_2017/scripts/montipora_b_vs_nb_trinity_sample_list.tx"
