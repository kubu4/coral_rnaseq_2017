#!/bin/bash
## Job Name
#SBATCH --job-name=trin_montipora
...
#SBATCH --workdir=/gscratch/scrubbed/samwhite/outputs/20190530_trinotate_montipora_all
...
trinity_out_dir="/gscratch/scrubbed/samwhite/data/montipora"
