#!/bin/bash
## Job Name
#SBATCH --job-name=20210825-mcap-hisat2-GCA_006542545.1_Mcap_UHH_1.1
...
# Set output filename
sample_name="20210825-mcap-hisat2"
...
# Input/output files
genome_index_dir="/gscratch/srlab/sam/data/M_capitata/genomes"
