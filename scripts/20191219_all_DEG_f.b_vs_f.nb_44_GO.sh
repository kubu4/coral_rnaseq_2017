...
salmon_out_dir="/media/sam/4TB_toshiba/porites/20191219_all_DEG_f.b_vs_f.nb_44_GO"
...
samples="/home/sam/gitrepos/coral_rnaseq_2017/scripts/porites_b_vs_nb_female_44_trinity_sample_list.txt"
...
# Move output folders
mv -b ${trimmed_reads_dir}/[BN][_B][_f]* \
${salmon_out_dir}
cd ${salmon_out_dir}
...
sed '/^Subject:/ s/ / JOB COMPLETE porites f 44 b-vs-nb/' ~/.default-subject.mail | msmtp "$EMAIL"
