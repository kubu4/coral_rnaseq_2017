#!/bin/bash
## Job Name
#SBATCH --job-name=20210721_pcom_busco_cnidaria_transcriptome_v2.0
...
#SBATCH --chdir=/gscratch/scrubbed/samwhite/outputs/20210721_pcom_busco_cnidaria_transcriptome_v2.0

### P.compressa transcriptome assembly completeness assessment using BUSCO.
### This is checking Cnidaria_MEGAN-extractions.fasta from 20210613_pcom_diamond_blastx_transcriptome.
...
transcriptome_fasta=/gscratch/srlab/sam/data/P_compressa/transcriptomes/Cnidaria_MEGAN-extractions.fasta
