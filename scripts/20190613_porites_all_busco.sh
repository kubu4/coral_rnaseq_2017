...
# BUSCO analysis for all porites transcriptome seqs

# Exit script if any command fails
set -e

## Input files and settings
base_name=porites_all
busco_db=/home/shared/busco-v3/metazoa_odb9
transcriptome_fasta=/media/sam/4TB_toshiba/porites/20180419_trinity/Trinity.fasta
