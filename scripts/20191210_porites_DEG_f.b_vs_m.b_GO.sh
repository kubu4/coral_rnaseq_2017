...
salmon_out_dir="/media/sam/4TB_toshiba/porites/20191210_porites_DEG_f.b_vs_m.b_GOO"
...
samples="/home/sam/gitrepos/coral_rnaseq_2017/scripts/porites_b-f_vs_b-m_trinity_sample_list.txt"
