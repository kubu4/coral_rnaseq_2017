...
# Sets max number of gene clusters to 12,000, to allow for heatmap generation
...
salmon_out_dir="/media/sam/4TB_toshiba/montipora/20191205_montipora_all_DEG_b_vs_nb_GO"
