...
salmon_out_dir="/media/sam/4TB_toshiba/porites/20191210_porites_all_DEG_44_vs_k5_GO"
...
samples="/home/sam/gitrepos/coral_rnaseq_2017/scripts/porites_44_vs_k5_trinity_sample_list.txt"
...
# Move output folders
mv ${trimmed_reads_dir}/[BN][_Bf][me]* \
${salmon_out_dir}
cd ${salmon_out_dir}
