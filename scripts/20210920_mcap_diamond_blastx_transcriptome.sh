#!/bin/bash
## Job Name
#SBATCH --job-name=20210920_mcap_diamond_blastx_transcriptome
...
#SBATCH --chdir=/gscratch/scrubbed/samwhite/outputs/20210920_mcap_diamond_blastx_transcriptome


## Script for running BLASTx (using DIAMOND) to annotate
## M.capitata genome-guided transcriptome assembly for downstream taxonomic
## assessment to ensure assembly is free of dinoflagellate sequences.
...
"${transcriptomes_dir}"/Trinity-GG.fasta \
)
