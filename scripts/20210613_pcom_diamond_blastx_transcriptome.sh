#!/bin/bash
## Job Name
#SBATCH --job-name=20210613_pcom_diamond_blastx_transcriptome
...
#SBATCH --chdir=/gscratch/scrubbed/samwhite/outputs/20210613_pcom_diamond_blastx_transcriptome
...
transcriptomes_dir=/gscratch/srlab/sam/data/P_compressa/transcriptomes
